...
class Modulo_dos_model extends CI_Model
{
	...
	public function insertar( $modulo_dos )
	{
		...
		$this->db->insert('modulo_dos', array('texto_uno'=>$modulo_dos['texto_uno'], 'fecha'=>$modulo_dos['fecha']));
		$id_insert = $this->db->insert_id();

		// Archivo 1
		if ( $modulo_dos['archivo_uno']['archivo_uno'] != '')
		{
			$this->db->insert('archivos', array('id_modulo_dos'=>$id_insert,
		...
		// Archivo 2
		if ( $modulo_dos['archivo_dos']['archivo_dos'] != '')
		{
			$this->db->insert('archivos', array('id_modulo_dos'=>$id_insert,
		...
		// Archivo 3
		if ( $modulo_dos['archivo_tres']['archivo_tres'] != '')
		{
			$this->db->insert('archivos', array('id_modulo_dos'=>$id_insert,
		...
		// Archivo 4
		if ( $modulo_dos['archivo_cuatro']['archivo_cuatro'] != '')
		{
			$this->db->insert('archivos', array('id_modulo_dos'=>$id_insert,
		...
		// Archivo 5
		if ( $modulo_dos['archivo_quinto']['archivo_quinto'] != '')
		{
			$this->db->insert('archivos', array('id_modulo_dos'=>$id_insert,
		...
		// Archivo 6
		if ( $modulo_dos['archivo_sexto']['archivo_sexto'] != '')
		{
			$this->db->insert('archivos', array('id_modulo_dos'=>$id_insert,
		...
		// Archivo 7
		if ( $modulo_dos['archivo_septimo']['archivo_septimo'] != '')
		{
			$this->db->insert('archivos', array('id_modulo_dos'=>$id_insert,
